        ...
        <div className="py-9 gap-y-10 text-[15px] md:text-[16px] flex flex-col items-start z-10 text-[#d2cece]">
          <div className="flex flex-col gap-6 md:gap-8">
            {[
              ...
              {
                href: 'https://leetcode.com/u/rohithapudu/',
                // icon: <FaGithub size={24} />,
                label: 'Leetcode',
                name: 'Rohitha Pudu',
              },
              {
                href: 'https://www.codechef.com/users/rohithapudu16',
                // icon: <FaLinkedin size={20} />,
                label: 'Code Chef',
                name: 'rohithapudu16',
              },
              {
                href: 'https://devpost.com/rohithapudu?ref_content=user-portfolio&ref_feature=portfolio&ref_medium=global-nav',
                // icon: <FaLinkedin size={20} />,
                label: 'DevPost',
                name: 'Rohitha Pudu',
              },
              {
                href: 'https://unstop.com/u/rohithapudu5134',
                // icon: <FaLinkedin size={20} />,
                label: 'Unstop',
                name: 'Rohitha Pudu',
              },
